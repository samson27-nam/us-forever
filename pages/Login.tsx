    ...
    <div className="min-h-[80vh] flex items-center justify-center px-6">
      <div className="bg-white w-full max-w-md rounded-[3rem] p-12 shadow-2xl border border-rose-50 animate-in fade-in zoom-in duration-500">
        <div className="text-center mb-10">
          ...
          <h2 className="text-4xl font-serif-elegant font-bold text-stone-900">Welcome Back</h2>
          <p className="text-stone-400 mt-2 italic">Continue our beautiful journey</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          >
            {loading ? <Loader2 className="animate-spin w-6 h-6" /> : 'Enter Our World'}
          </button>
        </form>

        <p className="mt-8 text-center text-stone-400 font-medium">
          New to this? <Link to="/register" className="text-rose-500 font-bold hover:underline">Create our account</Link>
        </p>
      </div>
    </div>
  );
