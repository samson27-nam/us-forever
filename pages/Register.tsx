...
import { Heart, User, Mail, Lock, Loader2, AlertCircle } from 'lucide-react';
    ...
    <div className="min-h-[80vh] flex items-center justify-center px-6">
      <div className="bg-white w-full max-w-md rounded-[3rem] p-12 shadow-2xl border border-rose-50 animate-in fade-in zoom-in duration-500">
        <div className="text-center mb-10">
          ...
          <h2 className="text-4xl font-serif-elegant font-bold text-stone-900">Start Our Story</h2>
          <p className="text-stone-400 mt-2 italic">A private space for our memories</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            <label className="text-xs font-black uppercase tracking-widest text-stone-400 ml-2">Your Name</label>
        ...
        <p className="mt-8 text-center text-stone-400 font-medium">
          Already have an account? <Link to="/login" className="text-rose-500 font-bold hover:underline">Login here</Link>
        </p>
      </div>
    </div>
  );
